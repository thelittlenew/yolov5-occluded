...
from utils.activations import MetaAconC, AconC
...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True):  # ch_in, ch_out, kernel, stride, padding, groups
        ...
        #使用AconC #self.act = MetaAconC(c1=c2) if act is True else (act if isinstance(act, nn.Module) else nn.Identity())
...
class SPP(nn.Module):
    ...
    def __init__(self, c1, c2, k=(5, 9, 13)):   #CSPP   k=(1, 5, 9, 13)
