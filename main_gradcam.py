...
import cv2
# 数据集类别名
names = ['orange']  # class names
# yolov5s网络中的三个detect层
#target_layers = ['model_17_cv3_act', 'model_20_cv3_act', 'model_23_cv3_act']
#target_layers = ['model-17', 'model-20', 'model-23']
target_layers = ['model-21', 'model-25', 'model-29']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="runs/train/rc+bi+ca2/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='data/1 (1193).jpg', help='input image path')
